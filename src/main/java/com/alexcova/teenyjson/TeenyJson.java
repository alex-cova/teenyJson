...
import com.alexcova.teenyjson.api.JsonDeserialize;
import com.alexcova.teenyjson.api.ValueParser;
import com.alexcova.teenyjson.api.ValueSerializer;
...
public final class TeenyJson {
     ...
     */
    @SuppressWarnings("unchecked")
    private @NotNull Object parseCollectionOrMap(Object value, @NotNull ParameterizedTypeHelper helper) throws JsonParsingException {
